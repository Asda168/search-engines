"""FastAPI app — also the Vercel entrypoint (see pyproject.toml's
[tool.vercel] entrypoint, which points here since this module isn't at
one of Vercel's default root-level entrypoint filenames).

Local dev: uvicorn webscraper.api:app --reload
